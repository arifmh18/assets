...
class Unit extends CI_Controller {
	...
	public function index()
	{
		...
		$data['breadcumb'] = '<li><a href="'.base_url().'dashboard"><i class="fa fa-dashboard"></i> Dashboard</a></li><li><i class="fa fa-files-o"></i> Master Data</li><li class="active">Unit Kerja</li>';
	...
	public function add()
	{
		...
		$data['judul'] = 'Tambah Data Unit Kerja';
		$data['breadcumb'] = '<li><a href="'.base_url().'dashboard"><i class="fa fa-dashboard active"></i> Dashboard</a></li><li><i class="fa fa-files-o"></i> Master Data</li><li><a href="'.base_url().'unit">Unit Kerja</a></li><li class="active">Tambah data</li>';
	...
	public function edit($id){
		...
		$data['judul'] = 'Edit Data Unit Kerja';
		$data['breadcumb'] = '<li><a href="'.base_url().'dashboard"><i class="fa fa-dashboard"></i> Dashboard</a></li><li><i class="fa fa-files-o"></i> Master Data</li><li><a href="'.base_url().'unit">Unit Kerja</a></li><li class="active">Edit Data</li>';
