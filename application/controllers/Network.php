...
class Network extends CI_Controller {
	...
	public function act_add()
	{
		...
		$this->form_validation->set_rules('no_switch', 'No Switch','trim');
		$this->form_validation->set_rules('no_socket', 'No Socket','trim');
		$this->form_validation->set_rules('no_kabel', 'No Kabel','trim');
