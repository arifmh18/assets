      <div class="box">
        ...
        <i class="fa fa-lightbulb-o"></i>
          <h3 class="box-title">Master Data Manufacturer</h3>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td><?php echo $value->kode_manufacturer ?></td>
                  <td><?php echo $value->manufacturer ?></td>
                  <td class="text-center">
                    <a href="<?php echo base_url()?>manufacturer/edit/<?php echo strEncrypt($value->kode_manufacturer); ?>" class="btn btn-warning"><span class="fa fa-edit"></span> Edit</a>
                    <button type="button" value="<?php echo $value->kode_manufacturer ?>" class="btn btn-danger confirm">
  ...
  $(document).on("click",".confirm",function(){
      ...
      swal({
          ...
          closeOnConfirm: true,
           ...
           $.ajax({
              url:"<?php echo base_url()?>manufacturer/hapus",
              type: "POST",
              data:{id:id},
