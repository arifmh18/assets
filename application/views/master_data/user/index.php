      <div class="box">
        ...
        <i class="fa fa-lightbulb-o"></i>
          <h3 class="box-title">Data Karyawan</h3>
            ...
            <a href="<?php echo base_url(); ?>user/add" class="btn btn-success btn-sm" data-toggle="tooltip" title="Tambah Data">&nbsp;&nbsp;&nbsp;<i class="fa fa-plus"></i>&nbsp;&nbsp;&nbsp;</a>
        </div></div>
        <div class="box-body">
      <div class="row">
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td><?php echo $value->no_badge ?></a></td>
                  <td><?php echo $value->username ?></td>
                  <td><a href="mailto:<?php echo $value->email?>"><?php echo $value->email ?></a></td>
                  <td><?php echo $value->jabatan ?></td>
                    <?php 
                    foreach ($unit as $key => $m) {
                      if ($value->unitname == $m->unitcode) {
                        echo "<td>".$m->unitname."</td>";
                      }
                     }
                     foreach ($lokasi as $key => $l) {
                      if ($value->lokasi == $l->code_loc) {
                        echo "<td>".$l->lokasi."</td>";
                      }
                     } 
                     ?>
                  <td class="text-center">
                    <a href="<?php echo base_url()?>user/edit/<?php echo strEncrypt($value->no_badge); ?>" class="btn btn-warning"><span class="fa fa-edit"></span> Edit</a>
                    <button type="button" value="<?php echo $value->no_badge ?>" class="btn btn-danger confirm">
